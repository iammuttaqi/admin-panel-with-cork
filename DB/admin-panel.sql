...
-- Dumping database structure for admin-panel
CREATE DATABASE IF NOT EXISTS `admin-panel` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `admin-panel`;
...
-- Dumping data for table admin-panel.categories: ~0 rows (approximately)
