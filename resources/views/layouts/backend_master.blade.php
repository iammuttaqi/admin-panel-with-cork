...
<!-- Mirrored from designreset.com/cork/ltr/demo6/starter_kit_blank_page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Mar 2020 05:32:44 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="{{ asset('backend_assets/fonts/fonts.css') }}" rel="stylesheet">
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('backend_assets/assets/img/logo.svg') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
