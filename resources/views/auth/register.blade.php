...
<!-- Mirrored from designreset.com/cork/ltr/demo6/auth_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Mar 2020 05:32:32 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <form class="text-left" method="post" action="{{ route('register') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="name-field" class="field-wrapper input">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="@error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email" required autocomplete="email" autofocus>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" type="password" class="@error('password') is-invalid @enderror" placeholder="Password" required autocomplete="new-password">
